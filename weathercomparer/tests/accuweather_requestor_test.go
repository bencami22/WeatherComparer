...
func TestWeatherRequest(t *testing.T) {
	...
	mux.HandleFunc("/currentconditions/v1/213490",
		func(res http.ResponseWriter, req *http.Request) {
			res.WriteHeader(http.StatusOK)
			res.Header().Set("Content-Type", "application/json")
			io.WriteString(res, "[{\"LocalObservationDateTime\":\"2019-11-03T17:12:00+01:00\",\"EpochTime\":1572797520,\"WeatherText\":\"Thundershower\",\"WeatherIcon\":42,\"HasPrecipitation\":true,\"PrecipitationType\":\"Rain\",\"IsDayTime\":false,\"Temperature\":{\"Metric\":{\"Value\":21.1,\"Unit\":\"C\",\"UnitType\":17},\"Imperial\":{\"Value\":70.0,\"Unit\":\"F\",\"UnitType\":18}},\"MobileLink\":\"http://m.accuweather.com/en/it/rome/213490/current-weather/213490?lang=en-us\",\"Link\":\"http://www.accuweather.com/en/it/rome/213490/current-weather/213490?lang=en-us\"}]")
		})
